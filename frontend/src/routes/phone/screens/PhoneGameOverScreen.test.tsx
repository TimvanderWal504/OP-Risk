...
describe('PhoneGameOverScreen', () => {
  ...
  it('toont beide namen bij meerdere winnaars, geen van beide de eigen speler', () => {
    const otherPlayer = { id: 'carol', name: 'Carol', colorId: 'green', roleId: null, isRoleActive: false, defenseBoostAvailable: false, isHost: false, isEliminated: false, hand: [], hasTradeableCardSet: false, handCount: 0, missionId: null }
