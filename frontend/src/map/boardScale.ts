 ...
 * `max(1500/4096, 790/1832)` = `max(0.3662, 0.4312)` — de hoogte bindt, en de breedte loopt
 * daar met dezelfde factor in mee: de achtergrond wordt 1766,29 eenheden breed en er valt links
 * en rechts 133,14 eenheid buiten beeld. Eén design-eenheid is dus `MAP_HEIGHT_PX / 790`
