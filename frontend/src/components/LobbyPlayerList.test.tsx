...
describe('LobbyPlayerList', () => {
  it('toont spelers en het aantal wacht-slots tot maxPlayers', () => {
    render(
      <LobbyPlayerList
        players={[
          { id: '1', name: 'Alice', colorId: 'red', roleId: null, isHost: true, isEliminated: false, hand: [], hasTradeableCardSet: false, handCount: 0, missionId: null },
        ]}
        colors={colors}
        roles={[]}
        maxPlayers={3}
  ...
  it('geeft een bijkomende rol op een bestaande kaart zijn eigen entrance-animatie', () => {
    render(
      <LobbyPlayerList
        players={[
          { id: '1', name: 'Alice', colorId: 'red', roleId: 'president', isHost: true, isEliminated: false, hand: [], hasTradeableCardSet: false, handCount: 0, missionId: null },
        ]}
        colors={colors}
        roles={roles}
        maxPlayers={3}
