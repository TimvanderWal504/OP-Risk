...
| `RegisterTv` (TV) | vóór een spel | Geen — geeft de aanroepende connectie een koppelcode (zelfde alfabet/lengte als een spelcode) voor "TV opzetten" (FO §2.2). Opnieuw aanroepen vervangt de vorige code van die connectie |
